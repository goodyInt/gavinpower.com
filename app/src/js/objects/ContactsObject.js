...
function Contacts() {
  ...
  introDiv.innerHTML = "<span class = 'introTitle'>Contact</span><span class ='introBody'>Thanks a lot for checking out my WebGL experiment. Please reach out and say hello.</span> ";
  ...
  contactDiv2.innerHTML = "<span class='infoTitle'>Email: </span><span class='infoBody'><a href='mailto:gavin@goodyInt.com?Subject=Hi%20from%20WebGL'target='_top'>gavin@goodyInt.com</a></span>";
  ...
  contactDiv3.innerHTML = "<span class='infoTitle'>Twitter: </span><span class='infoBody'>  <a href='https://www.twitter.com/goodyInt' target='blank'> @goodyGav</a></span>";
