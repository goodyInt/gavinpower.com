...
function CitySceneObject() {
 ...
 //   theParticles.visible = true;
  ...
  theParticles.position.y = -20;
  city.add(theParticles);
  theParticles.visible = false;
  ...
  var sunsetFromFive = function (currentIndex) {

    sunObject.sunInc = sunInclination;
    var sunsetTime = 2;
    var theDelay = 1;
    TweenMax.to(sunObject, sunsetTime, {
      delay: theDelay,
      sunInc: .525,
      ease: Power2.easeInOut,
      onUpdate: function () {
    ...
    TweenMax.to(_this.sunLight.position, sunsetTime, {
      delay: theDelay,
      y: 0,
      ease: Power2.easeInOut
    });
    TweenMax.to(_this.sunLight, sunsetTime, {
      delay: theDelay,
      intensity: 0,
      ease: Power2.easeInOut
    });
    TweenMax.to(sunColorObject, sunsetTime, {
      delay: theDelay,
  ...
  var sunriseForPrep = function (from) {
    ...
    TweenMax.to(_this.sunLight.position, riseTime, {
      delay: delayTime,
      y: 70,
      ease: Power2.easeInOut
    });
    TweenMax.to(_this.sunLight, riseTime, {
      delay: delayTime,
      intensity: 1.5,
      ease: Power2.easeInOut
    });

    TweenMax.to(sunColorObject, riseTime * .5, {
      delay: delayTime,
      sunlightColor: '#ecbe9e',
      sunColor: '#fdfdf5',
      ease: Power0.easeOut,
  ...
  this.startFromFive = function () {
    this.start(true)
  }


  this.start = function (fromFive) {
    ...
    TweenMax.to(theParticles.position, 2, {
      delay: 1,
      ease: Power1.easeOut,
      y: 0
    });
  ...
  var clearParticles = function () {
    ...
    TweenMax.to(theParticles.position, 1, {
      ease: Power1.easeOut,
      y: -20,
      onComplete: function () {
        theParticles.visible = false;
